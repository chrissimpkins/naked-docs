# -*- coding: utf-8 -*-
#
# Naked documentation build configuration file, created by
...
project = u'Naked'
copyright = u'2013, Christopher Simpkins'
...
latex_documents = [
  ('index', 'Naked.tex', u'Naked Documentation',
